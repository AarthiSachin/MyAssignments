...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		/*
		 * Launch URL "http://leaftaps.com/opentaps/control/login" 2. Enter UserName and
		 * Password Using Id Locator 3. Click on Login Button using Class Locator 4.
		 ...
		 * driver.getTitle() 17. Click on Duplicate button 18. Clear the CompanyName
		 * Field using .clear() And Enter new CompanyName 19.Clear the FirstName Field
		 * using .clear() And Enter new FirstName 20.Click on Create Lead Button 21. Get
